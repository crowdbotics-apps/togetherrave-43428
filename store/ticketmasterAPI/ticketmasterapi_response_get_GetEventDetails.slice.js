...
export const ticketmasterapi_get_v2_eventsjson_list = createAsyncThunk(
  "ticketmasterapi_response_get_GetEventDetails/ticketmasterapi_get_v2_eventsjson_list",
  async payload => {
...
const ticketmasterapi_response_get_GetEventDetailsSlice = createSlice({
  name: "ticketmasterapi_response_get_GetEventDetails",
  initialState,
  reducers: {},
  extraReducers: {
...
export default {
  ...
  slice: ticketmasterapi_response_get_GetEventDetailsSlice
}
